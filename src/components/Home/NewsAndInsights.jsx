...
function NewsAndInsights() {
  ...
  return (
    <div className="w-full px-4 sm:px-8 md:px-16 pt-16 lg:pt-28 bg-gray-50">
      <motion.h2
        className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-color mb-4"
      ...
      <div className="overflow-hidden mt-6 relative border-t border-b border-gray-300 py-3 bg-white shadow-md">
        <motion.div
          className="flex whitespace-nowrap space-x-8 text-lg sm:text-xl md:text-2xl text-gray-700 font-medium"
          animate={{ x: ["0%", "-100%"] }}
          transition={{
            repeat: Infinity,
            duration: 20,
        ...
        >
          <span>
            <span className="font-semibold text-primary-color">Baryalay.law</span>{" "}
